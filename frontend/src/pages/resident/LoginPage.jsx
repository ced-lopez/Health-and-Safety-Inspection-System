...
export default function ResidentLoginPage() {
  ...
  async function onSubmit(values) {
    ...
    try {
      const response = await login({ ...values, portal: "resident" });
      ...
      const redirectTo =
        location.state?.from?.pathname || "/resident/dashboard";
    ...
    <div className="flex min-h-svh items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-3 text-center">
          ...
          <CardDescription>
            Sign in to your resident portal to request inspections and track
            your clearances
          </CardDescription>
        </CardHeader>
